CREATE TABLE IF NOT EXISTS t_symbol (
    ...
    category            TINYINT         NOT NULL COMMENT '1=crypto,2=forex,3=metal,4=index',
    market_code         VARCHAR(32)     NOT NULL COMMENT '所属市场代码，如 CRYPTO、FX、METAL、US_INDEX',
...
CREATE TABLE IF NOT EXISTS t_trading_holiday (
    id                  BIGINT          PRIMARY KEY COMMENT '主键 ID（雪花 ID）',
    market_code         VARCHAR(32)     NOT NULL COMMENT '市场代码，如 CRYPTO、FX、METAL、US_INDEX',
